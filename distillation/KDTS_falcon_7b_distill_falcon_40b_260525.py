...
student.save_pretrained("../distilled-models-saved/models/falcon-7b-distill-falcon-40b")
tokenizer.save_pretrained("../distilled-models-saved/tokenizer/falcon-7b-distill-falcon-40b")
